...
from improvements.ker7_multirocket import MultiRocket
...
if __name__ == '__main__':
    ...
    classifier_name = "ker7_MultiRocket_{}".format(num_features)
    ...
    if os.path.exists(data_folder):
        ...
        output_dir = "{}/ker7_multirocket/resample_{}/{}/{}/".format(
            output_path,
            itr,
            classifier_name,
            problem
        ...
        df_metrics = pd.DataFrame(data=np.zeros((1, 19), dtype=float), index=[0], #21
